...
import torch
from src.models.precip_downscale.generic_model import GenericPrecipDownscaleModule
...
class UNetLitModule(GenericPrecipDownscaleModule):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return self.net(x, img_lr=None, sigma=torch.tensor(0.0, device=x.device))
