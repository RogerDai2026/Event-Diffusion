...
def main():
    ...
    ap.add_argument("--data-h5", default="/shared/qd8/event3d/MVSEC/hdf5/outdoor_night/outdoor_night1_data.hdf5")
    ap.add_argument("--gt-h5",   default="/shared/qd8/event3d/MVSEC/hdf5/outdoor_night/outdoor_night1_gt.hdf5")
    ap.add_argument("--side",    choices=["left", "right"], default="left",
                    help="DAVIS side to use. MVSEC canonical frame is LEFT; default is left.")
    ap.add_argument("--events-out", default="/shared/qd8/event3d/MVSEC/outdoor_night1_events/left")
    ap.add_argument("--depth-out",  default="/shared/qd8/event3d/MVSEC/outdoor_night1_depth/left")
